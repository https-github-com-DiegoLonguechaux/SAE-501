import "./Logo.css";
export default function Logo({width="140", height="160"}){
    return(
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 140 160" width={width} height={height}>
            ...
            <g class="color">
                ...
                <circle class="ring-mask blue" cx="44.9" cy="137.8" r="10.5" fill="none" stroke="#0081C8" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="10" stroke-dashoffset="23"/>
                <circle class="ring-mask black" cx="70" cy="137.8" r="10.5" fill="none" stroke="#000000" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="10" stroke-dashoffset="23"/>
                <circle class="ring-mask red" cx="95" cy="137.8" r="10.5" fill="none" stroke="#EE334E" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="10" stroke-dashoffset="23"/>
                </g>

                <g class="paralympics fade">
                <path class="agitos red" fill="#EE334E" d="M67.7,126.8c-3.3-0.8-7.7,0.1-11.9,2.5c-6.6,3.8-10.1,10.1-7.8,14c1.5,2.5,4.9,3.5,9,2.9
                c-1.8-0.4-3.3-1.4-4.1-2.8c-2.3-4,1.2-10.2,7.8-14C63,128,65.5,127.1,67.7,126.8z"/>
