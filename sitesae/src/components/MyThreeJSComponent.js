    ...
    render() {
        ...
        const accountSVG = (
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
            >
                <path xmlns="http://www.w3.org/2000/svg" d="M24 0C27.1826 0 30.2348 1.26428 32.4853 3.51472C34.7357 5.76515 36 8.8174 36 12C36 15.1826 34.7357 18.2348 32.4853 20.4853C30.2348 22.7357 27.1826 24 24 24C20.8174 24 17.7652 22.7357 15.5147 20.4853C13.2643 18.2348 12 15.1826 12 12C12 8.8174 13.2643 5.76515 15.5147 3.51472C17.7652 1.26428 20.8174 0 24 0ZM24 30C37.26 30 48 35.37 48 42V48H0V42C0 35.37 10.74 30 24 30Z" fill="#1B1B1B" />                </svg>
        );
        return (
